  ...
  return (
    <div className="max-w-lg mx-auto bg-white p-8 rounded-2xl shadow-sm border border-gray-100 mt-10">
      <div className="text-center mb-8">
         <h2 className="text-2xl font-black text-gray-800 mb-2">Kích Hoạt Bản Quyền</h2>
      ...
      <form onSubmit={handleActivate} className="space-y-4">
        ...
        <button 
          type="submit" 
          disabled={loading}
          className="w-full py-3 bg-gradient-to-r from-ucmas-blue to-blue-700 text-white rounded-xl font-bold hover:shadow-lg transition disabled:opacity-50"
        >
      ...
      <div className="mt-8 pt-6 border-t border-gray-100">
        <h3 className="text-xs font-bold text-gray-400 uppercase tracking-wide mb-3 text-center">TRẠNG THÁI HIỆN TẠI</h3>
        <div className="bg-gray-50 p-4 rounded-xl text-center">
           {user.license_expiry ? (
             <div className="text-green-600">
               <div className="font-bold text-lg mb-1">Đã kích hoạt</div>
               <div className="text-sm">Hạn sử dụng: <span className="font-mono font-bold text-gray-800">{new Date(user.license_expiry).toLocaleDateString('vi-VN')}</span></div>
             ...
             <div className="text-red-500 font-bold text-sm">Chưa có bản quyền</div>
           )}
        </div>
      </div>
    </div>
