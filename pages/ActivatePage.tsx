...
const ActivatePage: React.FC<ActivatePageProps> = ({ user, setUser }) => {
  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center px-4 py-10 bg-gradient-to-br from-gray-50 to-white">
      <div className="w-full max-w-lg bg-white p-4 sm:p-6 md:p-8 rounded-2xl shadow-sm border border-gray-100">
