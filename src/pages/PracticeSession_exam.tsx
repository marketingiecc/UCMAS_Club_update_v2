      ...
      <div className="min-h-[80vh] flex items-center justify-center py-12 px-4">
        ...
        <div className="bg-white rounded-[3rem] shadow-2xl p-10 w-full max-w-lg text-center border border-gray-100">
            ...
            <div className="flex flex-col gap-3">
               ...
               <button 
                 onClick={() => navigate('/contests', { state: { initialTab: 'practice' } })} 
                 className="w-full py-4 bg-white border-2 border-purple-500 text-purple-600 font-black rounded-2xl uppercase text-xs tracking-widest hover:bg-purple-50 transition shadow-sm flex items-center justify-center gap-2"
               >
                 ✨ Sáng tạo đề mới
               </button>
            </div>
